...
void main() {
  test('formatting', () {
    ...
    expect(geoFormatter.format(LatLong(9.99999999, 99.99999999)), '9 59 60.000,99 59 60.000');
    expect(geoFormatter.format(LatLong(-9.99999999, -99.99999999)), '-9 59 60.000,-99 59 60.000');

    geoFormatter = LatLongFormatter('{latc0d 0m 0s.sss},{lonc0d 0m 0s.sss}');
    expect(geoFormatter.format(LatLong(9.99999999, 99.99999999)), 'N09 59 60.000,E099 59 60.000');
    expect(geoFormatter.format(LatLong(-9.99999999, -99.99999999)), 'S09 59 60.000,W099 59 60.000');
